...
namespace SimpleJSON
{
    public enum JSONBinaryTag
    {
 	...
 	public class JSONException : Exception { //custom exception class
    ...
    public class JSONNode
    {
        ...
        public static JSONNode Parse(string aJSON)
        {
            ...
            while (i < aJSON.Length)
            {
                switch (aJSON[i])
                {
                    ...
                    case ']':
                        ...
                        if (stack.Count == 0)
                            throw new JSONException("JSON Parse: Too many closing brackets");
            ...
            if (QuoteMode)
            {
                throw new JSONException("JSON Parse: Quotation marks seems to be messed up.");
            }
            return ctx;
        }
