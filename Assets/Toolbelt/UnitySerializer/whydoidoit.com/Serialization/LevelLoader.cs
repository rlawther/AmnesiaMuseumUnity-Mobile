...
//					if (!sto.GameObject.GetComponent<StoreMaterials>())
//						sto.GameObject.AddComponent<StoreMaterials>();
					if (!sto.GameObject.GetComponent<StoreMesh>())
        ...
        using (new Radical.Logging())
        {
            ...
            if (!Application.isEditor) //if editor, make another script destroy this!
